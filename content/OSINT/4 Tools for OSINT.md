...
- **[Pipl](https://pipl.com/)** → Find personal information online.
- **[Facebook Graph Search Tools](https://inteltechniques.com/menu.html)** → Advanced search capabilities for Facebook.
...
- **[Spokeo](https://www.spokeo.com/)** → Search for personal details via digital footprints.
...
- **[FOCA](https://www.elevenpaths.com/labstools/foca/)** → Extract metadata from online documents.
...
- **[InVID](https://www.invid-project.eu/)** → Verify the authenticity of videos and images.
- **[FotoForensics](https://fotoforensics.com/)** → Detect image manipulation.
...
- **[What3Words](https://what3words.com/)** → Precise geolocation using unique keyword combinations.
- **[Geotagged Twitter](https://map.snapchat.com/)** → View geotagged tweets.

---

## **🕵️ OSINT Analysis & Automation**
...
- **[Buscador](https://inteltechniques.com/buscador/)** → Linux distribution specialized in OSINT.
